...
public class Ball extends Entity{
    ...
    public void getBallImage(){
        ...
        try {
            entityImage = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("/com/pongProject/balls/ball01.png")));
            entityImage2 = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("/com/pongProject/balls/ball02.png")));
            entityImage3 = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("/com/pongProject/balls/ball03.png")));
